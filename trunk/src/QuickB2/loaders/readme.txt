...
The loaders.proxies folder contains a bunch of classes that you use to define physics objects graphically in Flash CS*.  They all extend from MovieClip, and all use the component framework to define properties.